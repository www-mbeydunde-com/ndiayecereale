...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE ventes SET ID_produit=%s, quantite=%s, prix=%s, ID_client=%s WHERE ID_ventes=%s",
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr bgcolor="#D5EDB3">
    <td colspan="3" rowspan="2"><img src="mais-tige-pret-etre-recolte-dans-champ_1150-21861.jpg" width="361" height="183" /></td>
    <td height="77" colspan="3" id="logo" valign="bottom" align="center" nowrap="nowrap"><p>&quot;Mbey Dunde&quot;</p>
    <p><span class="Style1">mis-&agrave;-jour ventes</span> </p></td>
    <td width="327">&nbsp;</td>
  </tr>

  <tr bgcolor="#D5EDB3">
    <td height="100" colspan="3" id="tagline" valign="top" align="center">&nbsp;</td>
	<td width="327">&nbsp;</td>
  </tr>
 ...
 <tr>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="165" id="navigation">
        ...
        <tr>
          <td width="165"><a href="rechercher_vente.php" class="navText">Rechercher</a></td>
        </tr>
        <tr>
          <td width="165">&nbsp;</td>
        </tr>
        <tr>
          <td width="165"><a href="Sup_vente.php" class="navText">Supprimer</a></td>
        </tr>
      </table>
 	 <br />
  	&nbsp;<br />
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="ID_produit" value="<?php echo $row_Recordset1['ID_produit']; ?>" size="32"></td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right">Quantite:</td>
      <td><input type="text" name="quantite" value="<?php echo $row_Recordset1['quantite']; ?>" size="32"></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="ID_client" value="<?php echo $row_Recordset1['ID_client']; ?>" size="32"></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="ID_ventes" value="<?php echo $row_Recordset1['ID_ventes']; ?>">
</form>
